...
";
        ...
        public static List<string> TopPersons
        {
            get
            {
                return new List<string>() { "10分钟到账", "BUICKfifa", "bin-bin", "bobo", "godball", "jack", "sos73", "sweetcat", "歡樂今宵", "阿麦的理想", "八月十日", "大头", "低调的人", "飞天神猪", "高美尔", "格力电器", "积木", "九月九的酒", "绿野仙踪", "绿茵红魔", "马勒当拿", "美女", "民哥也疯狂", "明明白白", "摩连奴", "墨斗红云", "农夫果园", "飘雪", "强人", "轻轻巧巧", "人在美洲", "身不由己", "天巧星燕青", "天之骄子", "玩球全靠蒙", "我型我show", "我行我素", "无聊玩玩", "西班牙王子", "心情", "扬名立万", "爷有旺仔", "夜是彩市圆", "印加帝国", "赢球偷着乐", "余韵犹在", "章鱼帝", "中奖", "中奖太简单啦", "专搞下盘" };
            }
        }
    }
}
